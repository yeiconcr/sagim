...
export function BackupTab() {
  ...
  const handleRespaldar = async () => {
    try {
      ...
      if (!destino) { info("Backup cancelado"); return; }
  ...
  const handleRecuperar = async () => {
    try {
      ...
      if (!origen || Array.isArray(origen)) { info("Restauración cancelada"); return; }
      ...
      success("Restauración exitosa", "La base de datos fue restaurada. Reinicie la aplicación para aplicar los cambios.");
      setBackupStatus("success");
  ...
  return (
    <div className="max-w-2xl space-y-5 overflow-y-auto flex-1 min-h-0 pb-4">
          ...
          <div className="flex items-start gap-4">
            ...
            <div className="flex-1">
              ...
              <p className="text-sm text-slate-500 mb-4">
                Genera una copia del archivo <code className="bg-slate-100 px-1 rounded text-xs">sagim.db</code> en la ubicación que elija.
                Se recomienda hacer un backup diario al final de la jornada.
              </p>
            ...
            <div className="flex-1">
              ...
              <div className="flex items-start gap-2 bg-orange-50 border border-orange-200 rounded-lg p-3 mb-4">
                ...
                <p className="text-xs text-orange-700">
                  <strong>Atención:</strong> Esta operación reemplazará TODOS los datos actuales con el backup seleccionado.
                  Los datos actuales serán guardados automáticamente como respaldo antes de restaurar.
                  Reinicie la aplicación después de restaurar.
                </p>
              </div>
              <Button variant="outline" className="border-orange-400 text-orange-600 hover:bg-orange-50" onClick={handleRecuperar}>
      ...
      {/* Estado */}
      {backupStatus !== "idle" && (
        <Card className={backupStatus === "success" ? "border-green-200 bg-green-50" : "border-red-200 bg-red-50"}>
      ...
      <Card>
        <CardContent className="p-4">
          ...
          <div className="space-y-2 text-sm text-slate-500">
            ...
            <p>• Se recomienda guardar copias en una ubicación externa (USB, nube) periódicamente.</p>
