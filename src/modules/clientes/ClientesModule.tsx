...
export function ClientesModule() {
  ...
  const { clientePrecargado, clienteVistaInicial, setClientePrecargado, setClienteVistaInicial } =
    useAppStore();
  ...
  const cargarClienteYNavegar = useCallback(
    async (cedula: string, destino: 'pagos' | 'medidas') => {
      try {
  ...
  useEffect(() => {
    ...
    clientePrecargado,
    clienteVistaInicial,
    cargarClienteYNavegar,
    setClientePrecargado,
    setClienteVistaInicial,
  ]);
  ...
  switch (vista.tipo) {
    ...
    case 'pagos':
      return <ClientePagos cliente={vista.cliente} onVolver={irLista} />;
    case 'medidas':
      return <ClienteMedidas cliente={vista.cliente} onVolver={irLista} />;
  }
}
