...
interface MedRow { fecha: string; peso?: number|null; talla?: number|null; cintura?: number|null; brazos?: number|null; muslos?: number|null; torax?: number|null; cadera?: number|null; estatura?: number|null; }
interface Props { gimnasio: string; nit?: string|null; direccion?: string|null; telefono?: string|null; cliente: string; cedula: string; inscripcion: number; medidas: MedRow[]; generadoPor?: string; }
